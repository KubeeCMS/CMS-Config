...
namespace Kubecms\CMSConfig;

use Kubecms\CMSConfig\Exceptions\ConstantAlreadyDefinedException;
use Kubecms\CMSConfig\Exceptions\UndefinedConfigKeyException;

/**
 * Class Config
 * @package Kubecms\Kcms
 */
class Config
{
    /**
     ...
     * Config::apply();
     * // output: Fatal error: Uncaught Kubecms\Kcms\ConstantAlreadyDefinedException ...
     * ```
     *
     * @throws ConstantAlreadyDefinedException
     */
